...
$string['venuetab_name'] = 'Custom tab name';
$string['default'] = 'Default';
$string['default_help'] = 'Whether tab is enabled by default';
$string['label'] = 'Venue';
$string['pluginname'] = 'Video Time Venue tab';
$string['privacy:metadata'] = 'The Video Time Venue tab plugin does not store any personal data.';
