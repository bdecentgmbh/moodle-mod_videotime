 ...
 * needed to restore one videotimetab_interaction subplugin.
 */
class restore_videotimetab_interaction_subplugin extends restore_subplugin {
    /**
    ...
    protected function define_videotime_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/videotimetab_interaction');
        $paths[] = new restore_path_element($elename, $elepath);

        $elename = $this->get_namefor('cue');
        $elepath = $this->get_pathfor('/videotimetab_interaction_cues/videotimetab_interaction_cue');
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    /**
     * Processes the videotimetab_interaction element, if it is in the file.
     * @param array $data the data read from the XML file.
     */
    public function process_videotimetab_interaction($data) {
        global $DB;
     ...
     * @param array $data the data read from the XML file.
     */
    public function process_videotimetab_interaction_cue($data) {
        global $DB;
