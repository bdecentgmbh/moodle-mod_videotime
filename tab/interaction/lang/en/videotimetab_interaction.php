...
$string['prompteffect_help'] = 'Percentage applied to increase the time random interval between prompts after each successful response to an automatic continue prompt. If set to 100%, the average interval remains constant. If a prompt is missed, the average interval resets to its original setting.';
$string['questionno'] = 'Question {no}';
$string['questionshdr_help'] = 'Select the start and end times in the video where each question should a appear. Select behaviour:<dl><dt>No pause</dt><dd>Video plays uninterupted</dd><dt>Pause if incomplete</dt><dd>Pauses if question should still be answered</dd><dt>Pause video</dt><dd>Always pauses video when question appears</dd></dl>Questions need to be added the question bank before they can be selected.';
...
$string['spacing_desc'] = 'This provides default setting for prompts displayed randomly when video it playing. The time sets the average time for the first prompts to appear. The value may be changed in the course settings to adjust for video length.';
$string['spacing_help'] = 'Enable to set prompts to appear randomly when video it playing. The time affects the average time between prompts.';
