...
/**
 * Defines backup_videotimetab_related_subplugin class
 *
 ...
 */
class backup_videotimetab_related_subplugin extends backup_subplugin {
    ...
    protected function define_videotime_subplugin_structure() {
        ...
        $subplugintablesettings = new backup_nested_element('videotimetab_related',
        ...
        $subplugintablesettings->set_source_table('videotimetab_related',
