...
/**
 * Defines backup_videotimetab_chapter_subplugin class
 *
 ...
 */
class backup_videotimetab_chapter_subplugin extends backup_subplugin {
    ...
    protected function define_videotime_subplugin_structure() {
        ...
        $subplugintablesettings = new backup_nested_element('videotimetab_chapter',
        ...
        $subplugintablesettings->set_source_table('videotimetab_chapter',
