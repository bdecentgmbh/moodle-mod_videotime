...
$string['addtexttrack'] = 'Add text track';
...
$string['option_speed_help'] = 'Show the speed controls in the preferences menu and enable playback rate API (available to PRO and Premium accounts).';
...
$string['page-mod-videotime-view'] = 'Video Time view page';
$string['page-mod-videotime-x'] = 'Any Video Time module page';
...
$string['texttrack'] = 'Text track';
$string['texttrackno'] = 'Text track {no}';
$string['texttracks'] = 'Text tracks';
