...
$string['interval_help'] = 'The time wait before saving the video position. May be set longer when activities have a large number of concurrent users (live events)';
