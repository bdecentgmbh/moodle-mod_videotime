...
$string['option_dnt_help'] = 'Ask Vimeo not to track user data';
$string['autpause'] = 'Autopause';
$string['option_autpause'] = 'Autopause';
$string['option_autpause_help'] = 'Whether to pause the current video when another Vimeo video on the same page starts to play. Set this value to false to permit simultaneous playback of all the videos on the page. This option has no effect if youve disabled cookies in your browser, either through browser settings or with an extension or plugin.';
